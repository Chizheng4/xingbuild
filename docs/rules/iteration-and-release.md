...
内容 Observation、Article、Practice 和不改变页面能力的 B 端产品内容不进入产品版本；它们使用独立 `contentReleaseId`、ignored `.content-workspace/` 和独立 transport。内容 task 不读取产品 closeout/preflight 作为内容门禁，也不创建产品 commit/tag。
