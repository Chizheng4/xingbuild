...
历史候选登记（均已完成，不再作为下一版本输入）：

| 候选 ID | 文件 | 状态 | 进入条件 |
| --- | --- | --- | --- |
| `XBUILD-CAPABILITY-001` | [`design/v0.23.0 统一能力展示控件与可组合表达方案.md`](../design/v0.23.0%20统一能力展示控件与可组合表达方案.md) | `completed / v0.23.0` | 已完成发布；结果见 `history/v0.23.0.md` |
| `XBUILD-ARCH-VIEWS-001` | [`design/v0.22.0 企业经营体系多视图架构阅读能力方案.md`](../design/v0.22.0%20企业经营体系多视图架构阅读能力方案.md) | `completed / v0.22.0` | 已完成发布；结果见 `history/v0.22.0.md` |
...
- 当前公开基线：`v0.23.0`；当前没有正在实施的产品版本，也没有下一项 `confirmed` 候选。
- `XBUILD-CAPABILITY-001` 已完成发布；Robotaxi `/embed` 和具体运营内容仍按各自独立合同，不自动进入产品版本。
