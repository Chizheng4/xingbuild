...
export const robotaxiProductConfiguration = Object.freeze({
  heroActions: Object.freeze([
    Object.freeze({ id: "enter-robotaxi", label: "进入 Robotaxi 运营平台", href: robotaxiHref, kind: "external" }),
  ...
  closing: Object.freeze({
    ...
    action: Object.freeze({ label: "进入 Robotaxi 运营平台", href: robotaxiHref, kind: "external" }),
  }),
  productAction: Object.freeze({ label: "进入 Robotaxi 运营平台", href: robotaxiHref, kind: "external" }),
});
