...
test("digital relationship paths set the contracted visible default hierarchy", () => {
  assert.match(styles, /\.architecture-explorer__lines polyline \{[^}]*stroke:#475569;[^}]*stroke-width:1\.7/);
  assert.match(styles, /\.architecture-explorer__lines marker path \{ fill:#475569/);
...
test("relationship labels and arrows are rendered from the generated relationship set", () => {
  ...
  assert.match(tokens, /--color-architecture-edge: #475569/);
});
